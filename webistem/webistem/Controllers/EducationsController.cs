    ...
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Educations != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Educations'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("EducationId,UniversiteAdı,BolumunAdi,Ortalama,EgtimTarihi")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("EducationId,UniversiteAdı,BolumunAdi,Ortalama,EgtimTarihi")] Education education)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int? id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Educations'  is null.");
            }
            var education = await _context.Educations.FindAsync(id);
            if (education != null)
            {
